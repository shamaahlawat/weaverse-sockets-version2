...
const roomJoin = exports.roomJoin = (socket, io, msg) => {
    if (msg.room_id) {
        // msg.token && 
...
const roomJoin1 = exports.roomJoin1 = (socket, io, data) => {
    const { room_ids = [] } = data;
    if (room_ids.length) {
...
const roomLeave = exports.roomLeave = (socket, io, msg) => {
    if (msg.room_id) {
        // msg.token && 
        // if (msg.token != socket.id) {
...
const workspaceRoomJoin = exports.workspaceRoomJoin = (socket, io, msg) => {
